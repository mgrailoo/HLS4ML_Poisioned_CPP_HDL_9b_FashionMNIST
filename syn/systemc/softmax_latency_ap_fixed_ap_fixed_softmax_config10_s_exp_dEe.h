...
// ==============================================================
#ifndef __softmax_latency_ap_fixed_ap_fixed_softmax_config10_s_exp_dEe_H__
#define __softmax_latency_ap_fixed_ap_fixed_softmax_config10_s_exp_dEe_H__
...
struct softmax_latency_ap_fixed_ap_fixed_softmax_config10_s_exp_dEe_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(softmax_latency_ap_fixed_ap_fixed_softmax_config10_s_exp_dEe_ram) {
...
SC_MODULE(softmax_latency_ap_fixed_ap_fixed_softmax_config10_s_exp_dEe) {
...
softmax_latency_ap_fixed_ap_fixed_softmax_config10_s_exp_dEe_ram* meminst;


SC_CTOR(softmax_latency_ap_fixed_ap_fixed_softmax_config10_s_exp_dEe) {
meminst = new softmax_latency_ap_fixed_ap_fixed_softmax_config10_s_exp_dEe_ram("softmax_latency_ap_fixed_ap_fixed_softmax_config10_s_exp_dEe_ram");
